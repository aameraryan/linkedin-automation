...
# Marketing and Advertisement to be continued from D(51--200)
...
csv_file = open('staffing and recruiting-CSV.csv'.format(emp_size=emp_size), 'a')
...
for page in range(1, 46):
    ...
    url = 'https://www.linkedin.com/sales/search/people?companySize={alpha}&geo=us%3A0&industry=104&logHistory=true&logId=1805621275&page={page}&searchSessionId=nYL4aSEqTv6UELpxHe8Grw%3D%3D&title=IT%2520Manager%3A65%2CDirector%2520of%2520IT%3A163&titleTimeScope=CURRENT'.format(page=str(page), alpha=alpha)
    driver.get(url)
